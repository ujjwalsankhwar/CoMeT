...
file = open("64_Core_GCC_LBM_2.5D.trace", "r")
...
file = open("64_Core_LBM_GCC_2.5D.trace", "r")
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('64_Core/GCC_LBM/Max_Mem_Temperature/64_Core_Mem_GCC_LBM_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('64_Core/LBM_GCC/Max_Mem_Temperature/64_Core_Mem_LBM_GCC_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('64_Core/GCC_LBM/Max_Core_Temperature/64_Core_Core_GCC_LBM_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('64_Core/LBM_GCC/Max_Core_Temperature/64_Core_Core_LBM_GCC_2.5D.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('64_Core/GCC_LBM/Max_Mem_Core_Temperature/64_Core_Mem_Core_GCC_LBM_2.5D.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('64_Core/LBM_GCC/Max_Mem_Core_Temperature/64_Core_Mem_Core_LBM_GCC_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('64_Core/GCC_LBM/Max_Mem_Temperature_Gradient/64_Core_Mem_Grad_GCC_LBM_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('64_Core/LBM_GCC/Max_Mem_Temperature_Gradient/64_Core_Mem_Grad_LBM_GCC_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('64_Core/GCC_LBM/Max_Core_Temperature_Gradient/64_Core_Grad_GCC_LBM_2.5D.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('64_Core/LBM_GCC/Max_Core_Temperature_Gradient/64_Core_Grad_LBM_GCC_2.5D.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('64_Core/Combined/Max_Mem_Temperature/64_Core_Mem_2.5D.png')
plt.close()
...
plt.legend()
plt.title('Max Core Temperature vs Time')
plt.savefig('64_Core/Combined/Max_Core_Temperature/64_Core_Core_2.5D.png')
plt.close()