...
for i in directory:
	os.makedirs(i+"/Combined/Max_Mem_Temperature")
	os.makedirs(i+"/Combined/Max_Mem_Temperature_Gradient")
...
plt.savefig('4_Core/GCC_LBM/Max_Mem_Temperature/4_Core_Mem_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Mem_Temperature/4_Core_Mem_LBM_GCC.png')
plt.close()
...
plt.savefig('4_Core/GCC_LBM/Max_Core_Temperature/4_Core_Core_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Core_Temperature/4_Core_Core_LBM_GCC.png')
plt.close()
...
plt.savefig('4_Core/GCC_LBM/Max_Mem_Temperature_Gradient/4_Core_Mem_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Mem_Temperature_Gradient/4_Core_Mem_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/GCC_LBM/Max_Core_Temperature_Gradient/4_Core_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Core_Temperature_Gradient/4_Core_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Mem_Temperature/16_Core_Mem_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Mem_Temperature/16_Core_Mem_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Core_Temperature/16_Core_Core_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Core_Temperature/16_Core_Core_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Mem_Temperature_Gradient/16_Core_Mem_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Mem_Temperature_Gradient/16_Core_Mem_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Core_Temperature_Gradient/16_Core_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Core_Temperature_Gradient/16_Core_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Mem_Temperature/32_Core_Mem_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Mem_Temperature/32_Core_Mem_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Core_Temperature/32_Core_Core_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Core_Temperature/32_Core_Core_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Mem_Temperature_Gradient/32_Core_Mem_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Mem_Temperature_Gradient/32_Core_Mem_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Core_Temperature_Gradient/32_Core_Grad_GCC_LBM.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Core_Temperature_Gradient/32_Core_Grad_LBM_GCC.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('4_Core/Combined/Max_Mem_Temperature/4_Core.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('16_Core/Combined/Max_Mem_Temperature/16_Core.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('32_Core/Combined/Max_Mem_Temperature/32_Core.png')
plt.close()
...
plt.legend()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/Combined/Max_Mem_Temperature_Gradient/4_Core_Grad.png')
plt.close()

plt.plot(time_16_GCC_LBM,gradMem_16_GCC_LBM,label = "GCC_LBM")
plt.plot(time_16_LBM_GCC,gradMem_16_LBM_GCC,label = "LBM_GCC")
plt.ylabel('Temperature Gradient (in C)')
plt.xlabel('Time (in ms)')
plt.grid()
plt.legend()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/Combined/Max_Mem_Temperature_Gradient/16_Core_Grad.png')
plt.close()

plt.plot(time_32_GCC_LBM,gradMem_32_GCC_LBM,label = "GCC_LBM")
plt.plot(time_32_LBM_GCC,gradMem_32_LBM_GCC,label = "LBM_GCC")
plt.ylabel('Temperature Gradient (in C)')
plt.xlabel('Time (in ms)')
plt.grid()
plt.legend()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/Combined/Max_Mem_Temperature_Gradient/32_Core_Grad.png')
plt.close()