...
file = open("4_Core_GCC_LBM_3Dmem.trace", "r")
...
file = open("4_Core_LBM_GCC_3Dmem.trace", "r")
...
file = open("16_Core_GCC_LBM_3Dmem.trace", "r")
...
file = open("16_Core_LBM_GCC_3Dmem.trace", "r")
...
file = open("32_Core_GCC_LBM_3Dmem.trace", "r")
...
file = open("32_Core_LBM_GCC_3Dmem.trace", "r")
...
plt.savefig('4_Core/GCC_LBM/Max_Mem_Temperature/4_Core_Mem_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Mem_Temperature/4_Core_Mem_LBM_GCC_3Dmem.png')
plt.close()
...
plt.savefig('4_Core/GCC_LBM/Max_Core_Temperature/4_Core_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Core_Temperature/4_Core_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('4_Core/GCC_LBM/Max_Mem_Core_Temperature/4_Core_Mem_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('4_Core/LBM_GCC/Max_Mem_Core_Temperature/4_Core_Mem_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.savefig('4_Core/GCC_LBM/Max_Mem_Temperature_Gradient/4_Core_Mem_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Mem_Temperature_Gradient/4_Core_Mem_Grad_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/GCC_LBM/Max_Core_Temperature_Gradient/4_Core_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('4_Core/LBM_GCC/Max_Core_Temperature_Gradient/4_Core_Grad_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Mem_Temperature/16_Core_Mem_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Mem_Temperature/16_Core_Mem_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Core_Temperature/16_Core_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Core_Temperature/16_Core_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('16_Core/GCC_LBM/Max_Mem_Core_Temperature/16_Core_Mem_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('16_Core/LBM_GCC/Max_Mem_Core_Temperature/16_Core_Mem_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Mem_Temperature_Gradient/16_Core_Mem_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Mem_Temperature_Gradient/16_Core_Mem_Grad_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/GCC_LBM/Max_Core_Temperature_Gradient/16_Core_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('16_Core/LBM_GCC/Max_Core_Temperature_Gradient/16_Core_Grad_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Mem_Temperature/32_Core_Mem_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Mem Temperature vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Mem_Temperature/32_Core_Mem_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Core_Temperature/32_Core_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Max Core Temperature vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Core_Temperature/32_Core_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('32_Core/GCC_LBM/Max_Mem_Core_Temperature/32_Core_Mem_Core_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('32_Core/LBM_GCC/Max_Mem_Core_Temperature/32_Core_Mem_Core_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Mem_Temperature_Gradient/32_Core_Mem_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/LBM_GCC/Max_Mem_Temperature_Gradient/32_Core_Mem_Grad_LBM_GCC_3Dmem.png')
plt.close()
...
plt.grid()
plt.title('Temperature Gradient vs Time')
plt.savefig('32_Core/GCC_LBM/Max_Core_Temperature_Gradient/32_Core_Grad_GCC_LBM_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('4_Core/Combined/Max_Mem_Temperature/4_Core_Mem_3Dmem.png')
plt.close()
...
plt.grid()
plt.legend()
plt.savefig('16_Core/Combined/Max_Mem_Temperature/16_Core_Mem_3Dmem.png')
plt.close()
...
plt.legend()
plt.title('Max Core Temperature vs Time')
plt.savefig('4_Core/Combined/Max_Core_Temperature/4_Core_Core_3Dmem.png')
plt.close()
...
plt.legend()
plt.title('Max Core Temperature vs Time')
plt.savefig('16_Core/Combined/Max_Core_Temperature/16_Core_Core_3Dmem.png')
plt.close()
